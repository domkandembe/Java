...
<%-- 
    Document   : Fornecedor
    Created on : 5/mai/2023, 22:28:09
    Author     : HP
--%>
    ...
    <body>
        ...
        <div class="d-flex">
            <div class="card col-sm-3">
                <div class="card-body" >
                    <form action="Controller?menu=Fornecedor" method="POST">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>${dado.getId_fornecedor()}</td>
                            <td>${dado.getNome()}</td>
                            <td>${dado.getEmail()}</td>
                            <td>${dado.getTelefone()}</td>
                            <td>${dado.getEndereco()}</td>
                            <td >
                                <a class="btn btn-warning" href="Controller?menu=Fornecedor&accao=Editar&id=${dado.getId_fornecedor()}">Editar</a>
                                <a class="btn btn-danger" href="Controller?menu=Fornecedor&accao=Eliminar&id=${dado.getId_fornecedor()}">Eliminar</a>
                            </td>
                            </c:forEach>
                        </tr>  
                    </c:forEach>
